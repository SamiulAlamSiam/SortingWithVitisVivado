...
$(ObjDir)/insertionTb.c_pre.c.tb.o : insertionTb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) insertionTb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/insertion.c_pre.c.tb.o : insertion.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) insertion.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
