...
// wrapc file define:
#define AUTOTB_TVIN_array_r "../tv/cdatafile/c.group3.autotvin_array_r.dat"
...
#define AUTOTB_TVOUT_array_size "../tv/cdatafile/c.group3.autotvout_array_size.dat"
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.group3.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.group3.autotvout_output_r.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_array_r "../tv/rtldatafile/rtl.group3.autotvout_array_r.dat"
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.group3.autotvout_output_r.dat"
...
extern "C"
void group3_hw_stub_wrapper(void*, hls::sim::Byte<4>, void*);

extern "C"
void apatb_group3_hw(void* __xlx_apatb_param_array_r, hls::sim::Byte<4> __xlx_apatb_param_array_size, void* __xlx_apatb_param_output_r)
{
  static hls::sim::Register port0 {
    .name = "array_r",
    .width = 32,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_array_r),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_array_r),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_array_r),
#endif
  };
  port0.param = __xlx_apatb_param_array_r;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_array_size),
#endif
  };
  port1.param = &__xlx_apatb_param_array_size;
  ...
  try {
    ...
    group3_hw_stub_wrapper(__xlx_apatb_param_array_r, __xlx_apatb_param_array_size, __xlx_apatb_param_output_r);
